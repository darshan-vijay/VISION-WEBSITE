...
<body>
  ...
  <section  class="services" style="margin-top:60px;">
            <p class="event-name">Paper Presentation</p>
                ...
                <span></span>
					<li class="sky-tab-content-1">					
						<div class="typography">
							<h1>About Event</h1>
							<div class="descp">
							<p>&emsp;&emsp;All big things arises with innovative ideas. Stimulate your enthusiasm, for representing your valuable ideas related to Electronics, Communication or networking fields at our  Paper Presentation.</p>
							</div>
					...
					<li class="sky-tab-content-2">
						<div class="typography">
							...
							<div class="descp">
							<ol>
                               <li>Send your abstract (not more than a page) in pdf format to paperpresentationvision@gmail.com</li>
                               <li>Last date for the submission of abstract is April 11, 2021.</li>
                               <li>A group can have a maximum of 3 members.</li>
                               <li>Mention all the group members' names along with the year of study, department, college, mobile number, and email id.</li>
                               <li>We will send a confirmation mail to the mail id provided if selected.</li>
                            </ol>
					...
					<li class="sky-tab-content-3">
						<div class="typography">
							...
							<div class="descp">
							<p>Date: Round 1: April 15 (2PM - 3.30PM) </p>
							<p>Platform: e-Mail (paperpresentationvision@gmail.com) </p>
					...
					<li class="sky-tab-content-4">
						<div class="typography">
							<h1>Contact</h1>
							<div class="descp">
							<p>SUSHMITHA &nbsp;-&nbsp; Phone Number: 8870376716 </p>
                            <p>HARINI K &nbsp;-&nbsp; Phone #: 7092028561 </p>
							</div>
							<p class="text-right"><em>Click to go back to <a href="tech_events.php" > Tech Events Page</a>.</em></p>
						</div>
					</li>			
