...
$sql = "SELECT `matrimaze` FROM events where email = ?";
...
<body>
  ...
  <section  class="services" style="margin-top:60px;">
            <p class="event-name">Matrimaze</p>
                ...
                <span></span>
					<li class="sky-tab-content-1">					
						<div class="typography">
							<h1>About Event</h1>
							<div class="descp">
							<p>&emsp;&emsp;This is an MATLAB based event. It is aimed at testing the participant’s knowledge in MATLAB programming along with their ability to apply their theoretical and logical knowledge in resolving various challenges using the MATLAB environment.</p>
							<p>&emsp;&emsp;The entire event will be conducted in two rounds. The preliminary round is a Quiz, from which the eligible participant will be selected for the second round. The second round will be the MATLAB programming/simulation.</p>
							</div>
					...
					<li class="sky-tab-content-2">
						<div class="typography">
                            ...
                            <h3>Round 1</h3>
                            <ul>
							   <li>For participation in round 1, register in Dare2Compete platform.</p>
                               <li>This is an online quiz which consists of multiple-choice-questions and fill in the blanks.</li>
                               <li>It is a timed quiz and the participating teams should take the quiz at the stipulated time.</li>
                               <li>Basic knowledge of MATLAB Programming will be sufficient for the quiz.</li>        
                            </ul> 
                            <h3>Round 2</h3>
                            <ul>
                               <li>This is an MATLAB coding round.</li>
                               <li>This round will contain several questions for which the participants should develop corresponding MATLAB code.</li>
                               <li>Three days will be given for the completion of round two.</li>
                            </ul> 
					...
					<li class="sky-tab-content-4">
						<div class="typography">
							<h1>Contact</h1>
							<div class="descp">
							<p>VISHNU A &nbsp;-&nbsp; Phone Number:   9677531829 </p>
							</div>
                            <p class="text-right"><em>Click to go back to <a href="pre_events.php" > Pre-Events Page</a>.</em></p>
						</div>
					</li>			
...
function update() {
	console.log('Update');
	$.post('restapi.php?updateEvent=true&event=matrimaze', function(response) {
