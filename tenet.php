                ...
                <span></span>
					<li class="sky-tab-content-1">					
						<div class="typography">
							<h1>About Event</h1>
							<div class="descp">
							<p>&emsp;&emsp;“Time is irreversible but not the actions.”</p>

                            <p>&emsp;&emsp;Do you dream about turning back time to reclaim the things you’d lost? Do you have a penchant for creating passionate and yet creative stories through your videos? Do you think you’ve an eye for detail? Then, this pre-event is totally for you!</p>
							  
                            <p>&emsp;&emsp;Inspired by Christopher Nolan’s sci-fi thriller TENET, this event will have participants sending short reverse videos. The participants have to send their reversed videos to vision21nontech@gmail.com which will later be posted in our Instagram page. The best innovative video which wins the heart of the judges will be awarded.</p>
                            </div>
							<p class="text-right"><em>Go back to events page here <a href="events.php" > Events Page</a>.</em></p>
						</div>
					</li>
					...
					<li class="sky-tab-content-2">
						<div class="typography">
							...
							<div class="descp">
							<ol>
                               <li>The video should be based on the given theme.</li>
                               <li>One participant should send one entry only.</li>
                               <li>Send your entry to the given mail ID which will be informed later.</li>
                               <li>The selections of winners will be based on the number of likes and also the creativity and excellence of the video. Judges’ decision will be final.</li>
                               <li>The video should be taken with your own effort. Avoid plagiarism.</li>                  
                            </ol>
							</div>
							<p class="text-right"><em>Go back to events page here <a href="events.php" > Events Page</a>.</em></p>
						</div>
					...
					<li class="sky-tab-content-3">
						<div class="typography">
							...
							<div class="descp">
							<p>Time: </p>
							<p>Platform: e-Mail (vision21nontech@gmail.com) - Instagram </p>
					...
					<li class="sky-tab-content-4">
						<div class="typography">
							<h1>Contact</h1>
							<div class="descp">
							<p>JEEVANANDAM S &nbsp;-&nbsp; Phone Number: 88709 61363 </p> 
							</div>                   
							<p class="text-right"><em>Go back to events page here <a href="events.php" > Events Page</a>.</em></p>
						</div>
					</li>			
